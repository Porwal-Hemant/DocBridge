...
URL.createObjectURL(file) is a built-in JavaScript method that creates a temporary URL for a file.
It allows us to display locally uploaded images before uploading them to a server.
The URL points to the selected file in memory (not saved permanently).
